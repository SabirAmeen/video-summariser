...
import { UploadCloud, FileVideo, CheckCircle, FileText } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="space-y-4">
                ...
                <div className="group relative mt-2 flex justify-center rounded-2xl border-2 border-dashed border-zinc-800 px-6 py-16 transition-all duration-300 hover:border-indigo-500/50 hover:bg-zinc-900/50">
                    ...
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-300 blur-lg -z-10" />
                </div>
            </div>
