...
function LoginPage() {
  const tenantId = import.meta.env.VITE_AZURE_TENANT_ID_CREDS;
  const clientId = import.meta.env.VITE_AZURE_CLIENT_ID_CREDS;
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="mt-8 space-y-6">
            <a
              href={`https://login.microsoftonline.com/${tenantId}/oauth2/v2.0/authorize?client_id=${clientId}&scope=openid%20offline_access%20https%3A%2F%2Fgraph.microsoft.com%2Fmail.read&response_type=code`}
